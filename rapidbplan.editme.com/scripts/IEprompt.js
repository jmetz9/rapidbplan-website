...
function IEprompt(innertxt,def) {
   ...
   if (_isIE7) {
      ...
      if (_dialogPromptID==null) {
         ...
         _dialogPromptID.style.border='2px solid darkblue';
      ...
      var tmp = '<div style="width: 100%; background-color: darkblue; color: white; padding:3px; font-family: verdana; font-size: 10pt; font-weight: bold; height: 20px">Input Required</div>';
      tmp += '<div style="padding: 10px; color:black;">'+innertxt + '<BR><BR>';
